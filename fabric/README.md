...
phase-one host firewall are part of bootstrap; a dedicated consensus/worker
VLAN boundary is still mandatory before workers or child etcd prefixes exist.
Future Bootie provisioning is worker-only and post-gating.
